...
const ADDITIONAL_BRAND_PROTEIN_BAR_VARIANTS: ProteinBarVariant[] = [
  ...
  {
    name: "PowerBar 52% Protein+ - Chocolate Nut",
    marke: "PowerBar",
    imageUrl:
      "https://www.powerbar.com/cdn/shop/files/f72747a4880f4c2fa7aa416f3dd16013_48df90e4-290b-4b0a-a321-a70a530592a5.png?v=1760521897",
    summaryPrice: "11,95 EUR",
    detailPrice: "11,95 EUR / 4 x 50 g",
    gewicht: "4 x 50 g",
    servingLabel: "Riegel",
    zutaten: officialBarDescription("PowerBar", "52% Protein+", "Chocolate Nut"),
    nutrition: per100Nutrition({
  ...
  {
    name: "Barebells Protein Bar - Cookies and Cream",
    marke: "Barebells",
    imageUrl: "https://barebells.de/wp-content/uploads/sites/3/2025/12/BB_Bars_Cookies_And_Cream.png",
    summaryPrice: "27,99 EUR",
    detailPrice: "27,99 EUR / 12 x 55 g",
    gewicht: "12 x 55 g",
    servingLabel: "Riegel",
    zutaten: officialBarDescription("Barebells", "Protein Bar", "Cookies and Cream"),
    nutrition: per100Nutrition({
      servingWeightGrams: 55,
      energyKj: 1476,
      kcal: 353,
  ...
  },
  {
    ...
    marke: "Barebells",
    imageUrl:
      "https://barebells.de/wp-content/uploads/sites/3/2025/12/BB_Bars_White_Chocolate_Almond.png",
    summaryPrice: "28,99 EUR",
    detailPrice: "28,99 EUR / 12 x 55 g",
    gewicht: "12 x 55 g",
    servingLabel: "Riegel",
    zutaten: officialBarDescription("Barebells", "Protein Bar", "White Chocolate Almond"),
    nutrition: per100Nutrition({
      servingWeightGrams: 55,
      energyKj: 1552,
      kcal: 372,
  ...
  {
    name: "Barebells Protein Bar - Sunny Strawberry",
    marke: "Barebells",
    imageUrl: "https://barebells.de/wp-content/uploads/sites/3/2025/12/BB_Bars_Sunny_Strawberry.png",
    summaryPrice: "27,99 EUR",
    detailPrice: "27,99 EUR / 12 x 55 g",
    gewicht: "12 x 55 g",
    servingLabel: "Riegel",
    zutaten: officialBarDescription("Barebells", "Protein Bar", "Sunny Strawberry"),
    nutrition: per100Nutrition({
      servingWeightGrams: 55,
      energyKj: 1559,
      kcal: 373,
  ...
  {
    name: "Barebells Vegan Protein Bar - Caramel Choco Chip",
    marke: "Barebells",
    imageUrl:
      "https://barebells.de/wp-content/uploads/sites/3/2025/12/BB_Bars_Vegan_Chocolate_Chip.png",
    summaryPrice: "27,99 EUR",
    detailPrice: "27,99 EUR / 12 x 55 g",
    gewicht: "12 x 55 g",
    servingLabel: "Riegel",
    zutaten: officialBarDescription("Barebells", "Vegan Protein Bar", "Caramel Choco Chip"),
    nutrition: per100Nutrition({
      servingWeightGrams: 55,
      energyKj: 1520,
      kcal: 365,
  ...
  {
    name: "Bodylab Deluxe Protein Bar - Chocolate Peanut Caramel",
    marke: "Bodylab24",
    imageUrl:
      "https://www.bodylab24.de/cdn/shop/files/1-bodylab-deluxe-bar-display-open-chocolate-peanut-caramel_1_732f8427-eb90-49f7-99af-412c8bc7e8ef.jpg?v=1772179777&width=2048",
    summaryPrice: "28,99 EUR",
    detailPrice: "28,99 EUR / 12 x 50 g",
    gewicht: "12 x 50 g",
    servingLabel: "Riegel",
    zutaten: officialBarDescription("Bodylab24", "Deluxe Protein Bar", "Chocolate Peanut Caramel"),
    nutrition: per100Nutrition({
      servingWeightGrams: 50,
      energyKj: 1556.45,
      kcal: 372,
